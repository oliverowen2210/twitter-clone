...
export default function Signup(props) {
  const openSignupModal = useContext(ModalsContext).signup.toggle;
  return (
    <div className="w-[350px] pt-[12px] pb-[64px] border-[1px] border-solid border-gray-200 rounded-[16px] mb-[16px]">
      ...
      <div className="my-[16px] mx-[12px]">
        <button
          ...
          className="w-[300px] font-bold hover:bg-gray-200 h-[40px] duration-[0.2s] min-w-[36px] min-h-[36px] px-[16px] border-[1px] border-gray-400 rounded-full"
        >
          Sign up
        </button>
      </div>
